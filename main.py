...
app = FastAPI(title="Lumexa v8.6 Enterprise", version="8.6.0")
...
async def gemini_generate_script(prompt: str, previous_script: Optional[str] = None,
    ...
    if AI_PROVIDER == "claude":
        text = _claude_request(system_prompt, turns, temperature=0.15, max_tokens=3000)
    elif AI_PROVIDER == "gemini":
        text = _gemini_request(system_prompt, turns, temperature=0.15, max_tokens=3000)
    else:
...
def home():
    ...
    return {
        "status":"Lumexa v8.6 Enterprise — Vibe Engineering Edition",

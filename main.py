...
app = FastAPI(title="Lumexa v8.12 Enterprise", version="8.12.0",
...
# HARD and without notice — confirmed live: qwen/qwen3-coder:free (this
# file's original default) was delisted entirely within about a week of being
# set. Hard-wiring any single :free model id is fragile by design. Default is
# now "openrouter/free" — OpenRouter's OWN auto-routing meta-model, which
# always resolves to whatever free model is currently actually available,
# so this stops breaking every time the free roster rotates.
OPENROUTER_API_KEY = os.environ.get("OPENROUTER_API_KEY", "")
OPENROUTER_API_URL = "https://openrouter.ai/api/v1/chat/completions"
OPENROUTER_MODEL = os.environ.get("OPENROUTER_MODEL", "openrouter/free")
# The auto-router may pick a text-only model — image-to-params needs a
# vision-capable model specifically if you use that endpoint. Override
# OPENROUTER_VISION_MODEL explicitly (e.g. to a confirmed vision :free model)
# rather than relying on the auto-router for that one endpoint.
...
def home():
    ...
    return {
        "status":"Lumexa v8.12 Enterprise — Vibe Engineering Edition",

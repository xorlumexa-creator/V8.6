...
app = FastAPI(title="Lumexa v8.11 Enterprise", version="8.11.0",
...
# free ones (:free suffix). Default here is qwen/qwen3-coder:free, a
# code-specialized model well suited to this task specifically, with real
# free-tier headroom (reports vary 200-1000 req/day depending on account
# history) — better fit for a zero-budget setup than Gemini's own free tier.
OPENROUTER_API_KEY = os.environ.get("OPENROUTER_API_KEY", "")
OPENROUTER_API_URL = "https://openrouter.ai/api/v1/chat/completions"
OPENROUTER_MODEL = os.environ.get("OPENROUTER_MODEL", "qwen/qwen3-coder:free")
# qwen3-coder is text-only (no image input) — image-to-params needs a
# different, vision-capable model if you route that through OpenRouter too.
# Override OPENROUTER_VISION_MODEL explicitly if you use that endpoint.
...
def home():
    ...
    return {
        "status":"Lumexa v8.11 Enterprise — Vibe Engineering Edition",
